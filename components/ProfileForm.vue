  ...
  <form @submit.prevent>
    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <input v-model="profile.firstName" type="text" name="first-name" id="first-name" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
        </div>
      </div>
      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <input v-model="profile.lastName" type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
        </div>
      </div>
      ...
      <div class="sm:col-span-3 w-full rounded overflow-hidden shadow-lg mt-8">
      ...
      <div class="sm:col-span-3 w-full rounded overflow-hidden shadow-lg">
        <div class="border-gray-200 bg-white px-4 py-5 sm:px-6">
      ...
      <div class="sm:col-span-6">
        <label for="maritalStatus" class="block text-sm font-medium leading-6 text-gray-900">Marital Status</label>
        <select id="maritalStatus" name="maritalStatus" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
          <option v-for="status in profile.maritalStatus">{{status}}</option>
        </select>
      </div>

      <div class="sm:col-span-6">
        <label for="ethnicity" class="block text-sm font-medium leading-6 text-gray-900">Ethnicity</label>
        <select id="ethnicity" name="ethnicity" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
          <option v-for="ethnicity in profile.ethnicity">{{ethnicity}}</option>
        </select>
      </div>
    </div>    
  </form>
